...
public class Autocomplete {
	...
	public Autocomplete(JTextComponent textComp, Window mainWindow, ArrayList<String> words, Color popUpBackground,
	...
	private void showPopUpWindow() {
		...
		if (textComp instanceof JTextField) {// calculate x and y for JWindow at bottom of JTextField
			windowX = container.getX() + textComp.getX();
			...
			windowY = (int) (rect.getY());
		}

		// show the pop up
		autoSuggestionPopUpWindow.setLocation(windowX, windowY - 30);
		autoSuggestionPopUpWindow.setMinimumSize(new Dimension(textComp.getWidth(), 30));
