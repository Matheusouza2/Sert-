...
public class CadClienteNovo extends JDialog {
	...
	public static void main(String[] args) {
		try {
			CadClienteNovo dialog = new CadClienteNovo(1, 0);
	...
	// chamado o editar
	public CadClienteNovo(int opcao, int idEdit) {
		...
		panelBtn.setBounds(10, 644, 1000, 113);
		...
		tabbedPane.setBounds(232, 44, 778, 589);
		...
		txtAreaObs.setBounds(10, 322, 753, 88);
		...
		scrollPane_1.setBounds(10, 44, 212, 589);
